...
require_once($CFG->dirroot . '/mod/onlinejudge/moodle2/lib.php');
...
class assignment_base {
    ...
    function assignment_base($cmid='staticonly', $assignment=NULL, $cm=NULL, $course=NULL) {
        ...
        $this->strassignment = get_string('modulename', 'onlinejudge');
        $this->strassignments = get_string('modulenameplural', 'onlinejudge');
        $this->strsubmissions = get_string('submissions', 'onlinejudge');
    ...
    function submittedlink($allgroups=false) {
        ...
        if (has_capability('mod/assignment:grade', $context)) {
            ...
            if ($this->type == 'offline') {
                ...
                $submitted = '<a href="'.$urlbase.'submissions.php?id='.$this->cm->id.'">'.
                             get_string('noattempts', 'onlinejudge').'</a>';
            }
        } else {
            if (isloggedin()) {
