...
$PAGE->set_url('/mod/onlinejudge/submission.php', array('id'=>$id,'offset'=>$formdata->offset,'forcerefresh'=>$formdata->forcerefresh,'userid'=>$formdata->userid,'mode'=>$formdata->mode));
$PAGE->set_title(get_string('submissionPageTitle', 'onlinejudge'));
...
$table = new flexible_table('submission table');
$table->define_baseurl('/mod/onlinejudge/submission.php');
$table->define_columns(array('a','b','c'));
$table->define_headers(array('aa', 'bb', 'cc'));
$table->setup();
$table->add_data(array('aaa','bbb','ccc'), 'dimmed_text');
$table->finish_output();
